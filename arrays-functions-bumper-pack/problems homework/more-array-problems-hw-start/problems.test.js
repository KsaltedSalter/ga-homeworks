...
describe("Odds and Evens", () => {
  test("Should return strings of 'even' and 'odd' in place of even and odd numbers", () => {
    expect(fns.oddsAndEvens([1, 2, 3, 4, 5, 6, 7, 8])).toEqual([
      "odd",
      "even",
      "odd",
      "even",
    ...
    expect(fns.oddsAndEvens([1, 3, 5, 7, 9, 11])).toEqual([
      "odd",
      "odd",
      "odd",
      "odd",
    ...
    expect(fns.oddsAndEvens([2, 4, 6, 8, 10, 12])).toEqual([
      "even",
      "even",
      "even",
      "even",
...
xdescribe("beginsWithB", () => {
  test("should return only words begining with uppercase B", () => {
    expect(
      fns.beginsWithB(["Boulder", "banana", "Tennis", "leg", "Berry"])
    ).toEqual(["Boulder", "Berry"]);
    expect(
      fns.beginsWithB(["Coca-Cola", "Bottle", "Bag", "Beef", "tango"])
    ).toEqual(["Bottle", "Bag", "Beef"]);
  });
});
